% definition for subdirs, do not change it!
\expandafter\def\csname input@path\endcsname{%
    {sty/},% cls,cfg file
    {img/},% images
...
\documentclass[numbers,compress]{vmsta2}
...
\begin{aug}
\author[a]{\inits{F.N.}\fnms{First-Name1}~\snm{Surname-1}\thanksref{cor1}\ead[label=e1]{first@somewhere.com}\orcid{0000-0000-0000-0000}}
\thankstext[type=corresp,id=cor1]{Corresponding author.}
\author[b]{\inits{S.N.}\fnms{First-Name2}~\snm{Surname-2}\thanksref{f1}\ead[label=e2]{second@somewhere.com}}
...
usually few lines long, \cny{Country}}
\runauthor{F.N. Author, S.N. Author}
\end{aug}
...
\bibliographystyle{bib/vmsta2-mathphys}
