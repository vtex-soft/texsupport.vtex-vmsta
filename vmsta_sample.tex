...
\author[a]{\inits{F.}\fnm{First-Name1}\snm{Surname-1}\corref{cor1}}\email{first@somewhere.com}
\cortext[cor1]{Corresponding author.}

\author[b]{\inits{S.}\fnm{First-Name2}\snm{Surname-2}\fnref{f1}}\email{second@somewhere.com}
\fntext[f1]{Some remarks.}
...
benedixit filiis tuis in te.\end{abstract}

\begin{keyword} Sample \sep \LaTeX
...
Isi aedificaverit domum \citep{BLG09,BlanLedShi10}, in vanum \cite*{XiuliChao1999} laboraverunt qui aedificant eam.
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}cD{.}{.}{6.1}D{.}{.}{2.1}D{.}{.}{2.1}D{.}{.}{0}D{.}{.}{2.1}D{.}{.}{1.3}D{.}{.}{1.3}D{.}{.}{1.3}@{}}
\hline
